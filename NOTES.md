...
2022-12-04 | 2.50  | `not instanceof` in coffee compat; `#### single line comments`; `not of`; `for ... by`; restored suppress indented application hack
