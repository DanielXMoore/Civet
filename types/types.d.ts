...
export type ParseOptions = Partial<{
   ...
   */
  operators: string[] | Record<string, string | undefined> | undefined
  react: boolean
  solid: boolean
  client: boolean
...
export class SourceMap {
  ...
  lines: SourceMapping[][]
  /** @deprecated Only present in older Civet versions; use lines instead. */
...
export class ParseError {
  ...
  /** Generated errors without a source position have no offset. */
  offset?: number
}
