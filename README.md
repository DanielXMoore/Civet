...
features look and behave similarly, when seeing a new feature you could have a good idea what it does,
...
amplify its power. We're not trying to change ES semantics, we present them in a coherent and expressive
way.
...
Civet evolves. As the official JS and TS specification evolve into the future Civet also evolves favoring compatibility.
